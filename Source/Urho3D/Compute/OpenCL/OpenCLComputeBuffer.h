...
namespace Urho3D
{
    ...
    class URHO3D_API OpenCLComputeBuffer : public ComputeBuffer
    {
        OpenCLComputeBuffer(const OpenCLComputeBuffer&) = delete;
        void operator=(const OpenCLComputeBuffer&) = delete;
    public:
        /// Construct a buffer object for the given compute device.
        OpenCLComputeBuffer(const String& name, OpenCLComputeDevice*, unsigned size, unsigned settings);
        /// Construct a 2d image object for the given compute device.
        OpenCLComputeBuffer(const String& name, OpenCLComputeDevice*, unsigned width, unsigned height, unsigned settings);
        /// Construct a 3d image object for the given compute device.
        OpenCLComputeBuffer(const String& name, OpenCLComputeDevice*, unsigned width, unsigned height, unsigned depth, unsigned settings);
